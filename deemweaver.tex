...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Objective}
Self-taught python programmer with over 5 years of experience. Django user, MVC advocate. Enjoy working with Git, databases, writing and scheduling bash scripts, and using new technology. Interested in a new position where I can use my programming skills to solve challenging problems, ideally working on a core product.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     EXPERIENCE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
