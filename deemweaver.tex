...
JavaScript\textbullet{}C \textbullet{}C++  \textbullet{}Go  \\
CSS\textbullet{}Android \textbullet{}SQL \textbullet{}Java\\
\location{Familiar:}
BASH \textbullet{}Ruby \textbullet{}PHP \textbullet{}R\\
\sectionsep
...
\descript{| Python Engineer}
\location{May 2016 - Present | Paris, FR | Remote}
\begin{tightemize}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\item Wrote python script to deploy high-availability enterprise clusters from basic config file, using Fabric and Mako templates. This process was previously handled manually by a DevOps specialist.
\item Deploy AWS clusters for enterprise customers using the above script.
\item Added SMTP information to our standard product's environment variables, to allow sending email using applications other than the sendmail utility.
\item Wrote a bash script to automate the deployment of existing Wordpress sites to our PaaS.
\end{tightemize}
\sectionsep
...
\item Automated monthly inventory valuation and upload of the corresponding journal entry to our accounting system, using Python, PostgreSQL and Linux Upstart.
